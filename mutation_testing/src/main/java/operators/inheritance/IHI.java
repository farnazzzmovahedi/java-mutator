...
//                    String fieldName = parentField.getVariable(0).getNameAsString();
//
...
//                                parentField.getVariable(0).getType(), // Same type as parent's field
//                                fieldName // Same name as parent's field
//                        );
//                        hiddenVariable.setInitializer("0"); // Default initializer
